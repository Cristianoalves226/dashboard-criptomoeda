...
export default function App() {
  ...
  return <div className="min-h-screen bg-[#070a0f] text-white font-sans">
    <Header mobileOpen={mobileOpen} setMobileOpen={setMobileOpen} goToMarkets={goToMarkets} setPage={changePage} />
    <div className="mx-auto flex max-w-[1500px]"><Sidebar page={page} setPage={changePage} mobileOpen={mobileOpen} setMobileOpen={setMobileOpen} />
      <main className="min-w-0 flex-1 p-4 md:p-8">
        {page === 'overview' && <Overview hideBalance={hideBalance} setHideBalance={setHideBalance} currency={currency} setPage={changePage} holdings={holdings} />}
        {page === 'wallet' && <Wallet hideBalance={hideBalance} setHideBalance={setHideBalance} currency={currency} holdings={holdings} transactions={transactions} onSendConfirm={handleSendConfirm} onSwapConfirm={handleSwapConfirm} />}
        {page === 'markets' && <div key={marketsQuery}><Markets currency={currency} initialQuery={marketsQuery} /></div>}
        {page === 'settings' && <Settings currency={currency} setCurrency={setCurrency} hideBalanceDefault={hideBalanceDefault} setHideBalanceDefault={handleSetHideBalanceDefault} priceAlerts={priceAlerts} setPriceAlerts={setPriceAlerts} emailUpdates={emailUpdates} setEmailUpdates={setEmailUpdates} />}
      </main>
    </div>
  </div>;
}
